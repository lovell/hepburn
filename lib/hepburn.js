...
function bulkReplace (str, map, regex) {
  regex = regex || new RegExp(Object.keys(map).join("|"), "g");
  return str.replace(regex, function (group) { return map[group] || group });
}
...
var choonpu = "ー";
var choonpuMap = { "Aー": "Ā", "Iー": "Ī", "Uー": "Ū", "Eー": "Ē", "Oー": "Ō" };
...
exports.fromKana = function(str) {
  ...
  str = bulkReplace(str, katakanaHalfwidthsCombined, /[ｦ-ﾝ][ﾞﾟ]/g);
  str = bulkReplace(str, katakanaHalfwidths, /[ｦ-ﾝ]/g);
  str = bulkReplace(str, hiraganaDigraphs, /[ぁ-ゖゟ][ぁぃぅぇぉゃゅょ]/g);
  str = bulkReplace(str, katakanaDigraphs, /[ァ-ヺー][ァィゥェォャュョ]/g);
  str = bulkReplace(str, hiraganaMonographs, /[ぁ-ゖゟ]/g);
  str = bulkReplace(str, katakanaMonographs, /[ァ-ヺー]/g);
  ...
  str = str.replace(/[AIUEO]ー/g, function (char) {
    return choonpuMap[char] || char
  });
...
exports.toHiragana = function(str) {
  ...
  // Transliteration
  str = bulkReplace(str, hiraganaMap, hiraganaRegex);
...
exports.toKatakana = function(str) {
  ...
  // Transliteration
  str = bulkReplace(str, katakanaMap, katakanaRegex);
